...
ROUTER_PROMPT = """
You are an expert TPA Benefits Query Router.
...
You are a TPA Billing & Claims Specialist. Answer the employee's billing question using ONLY the provided context.
Rules:
...
You are a TPA Dental Coverage Specialist. Answer the employee's question using ONLY the provided context.
Rules:
...
You are a TPA Benefits & Coverage Specialist. Answer the employee's question using ONLY the provided context.
Rules:
...
# 3. CRITIC / REVIEWER PROMPT

CRITIC_PROMPT = """
You are a TPA Compliance & Quality Audit Critic evaluating an AI Specialist's draft output.
Audit Checklist:
...
Context: {context}
Question: {user_question}
Draft Output: {specialist_output}
"""

# 4. FINAL SYNTHESIZER PROMPT
SYNTHESIZER_PROMPT = """
You are the primary TPA Customer Support Assistant.
